...
app = Flask(__name__)
#Line-bot
line_bot_api = LineBotApi('wb5bX73FF0Nc4ooGEUwiaoF7VECFZuITieKLRmznHkzlkF4N0VQpnV/YgO0HAbcQo8vKq/YU/dFh51qAr+HyRkgkYWtGFnbJcVrlry4a6gyhBUwOVTdzYgXyw3WsZIL6/S3bUbzpSOaCx5WYZSNbOgdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('2ed998fbf6594a6fab1a60c4995baeb5')
...
def eat(x,y):
    ...
    if r.status_code == 200:
        ...
        for t,l,a,h,u in zip(title,star,address,time,url):
            ...
            map_list.append('https://www.google.com.tw/maps/dir//'+a.text)
...
def image_carousel(store_list,star_list,address_list,img_url_list,time_list,url_list,alt_text,map_list):
    contents = dict()
    contents['type'] = 'carousel'
    contents['contents'] = []
    i=0
    for store, star, address, img, time ,url1, mapi in zip(store_list,star_list,address_list,img_url_list,time_list,url_list,map_list):
